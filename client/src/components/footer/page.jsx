        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10 ">
          ...
          <div>
            ...
            <a href="/" className="flex items-center  mr-8">
              <svg
                className="h-8 w-8 mr-2 text-white bg-blue-600 rounded-full p-2"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
              ...
              <a
                href="/"
                className="py-3 font-semibold px-8 block w-fit bg-pink-600 hover:bg-pink-700 rounded-full shadow-sm text-sm text-white mx-auto transition-all  duration-500 lg:mx-0"
              >
                {" "}
                Contact us{" "}
              </a>
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-white ">
              ©<a href="https://pagedone.io/">skillhub</a> 2024, All rights
              reserved.
            </span>
